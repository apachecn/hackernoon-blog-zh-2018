...
> 原文：<https://medium.com/hackernoon/engineering-whiteboard-interviews-yay-or-nay-7e4c5e7c6b88>

![](img/9882691db73102e60f28c42a06490f36.png)

Originally published at [Key Values](https://www.keyvalues.com/blog/should-tech-companies-use-quotas-to-increase-diversity) on August 9th, 2018, image by [Mark Rabe](https://unsplash.com/photos/zCJrolkwRyE) on Unsplash.
...
# [杰米·卡拉克](https://www.linkedin.com/in/jamiekarraker/)

首席技术官在[奥拓](https://www.keyvalues.com/alto)，以前在脸书工程(解析)。
...
[中型](https://www.keyvalues.com/medium)的工程经理，之前在 Pivotal Labs 从事工程工作。
...
# [丹·埃里克森](https://twitter.com/techwraith)

[Eaze](https://www.keyvalues.com/eaze) 的工程副总裁，之前是 Getable 的 CTO 和 Yammer 的工程师。
...
![](img/4931d9509fecee627987c9a907b0dbc6.png)

# [德斯蒙德品牌](https://twitter.com/dmnd_)

Flexport 的工程总监，之前在可汗学院和微软工作。

白板面试可能不会受到中间候选人的欢迎，但我认为凯文·拉克尔在这篇博文底部的[例子中找到了答案。](http://lacker.io/tech/2017/04/05/why-you-cant-say.html)

然而，白板本身并没有什么特别之处。在 [Flexport](https://www.keyvalues.com/flexport) ，我们让人们选择在他们自己的笔记本电脑上写代码，如果他们愿意的话，有些人会接受我们的建议。这对于那些使用 TDD 风格的过程或者只是喜欢在其他文本之前插入文本的人来说更好:)
...
[Honor](https://www.keyvalues.com/honor) 的联合创始人，之前创立了 Meebo，并于 2012 年将其出售给谷歌。

从功能的角度来看，这不是很有用…没有人会把在白板上写代码作为他们的主要工作。然而，这是了解候选人如何沟通、表达想法和接受反馈的好方法。期望不是在白板问题上获得高分，而是更多地了解你这个潜在的团队成员。

# [常伟](https://www.linkedin.com/in/davidachang/)

在 [NerdWallet](https://www.keyvalues.com/nerdwallet) 工作的工程经理，之前在 aboutLife 工作。

没有一个最好的方法来评估工程候选人。所有的面试过程都有自己的优点和缺点，了解任何一个问题能告诉你多少关于候选人的信息是很重要的。

在 [NerdWallet](https://www.keyvalues.com/nerdwallet) ，我们通常在白板上提出架构和设计问题。它有助于我们更好地理解候选人如何构建和交流复杂的技术解决方案，设计的总体思路比任何特定代码行的细节都更重要。出于显而易见的原因，我们通常也会问几个笔记本电脑编码问题。最近，我们加入了一个拉请求问题，因为在 [NerdWallet](https://www.keyvalues.com/nerdwallet) 与他人一起工作并给出反馈是成为一名高效工程师的关键部分，而我们在之前的面试过程中遗漏了这一点。
...
![](img/bd6083f1210b58d0eb768f1ea8295cbc.png)

Image by [Trent Erwin](https://unsplash.com/@tjerwin) on Unsplash.

# [齐莎·柯里布霍](https://www.linkedin.com/in/zeesha/)

[分支](https://www.keyvalues.com/branch)的产品工程总监，之前是 Evernote 增强智能团队的副总裁。

我整个职业管理生涯都在辩论面试候选人的最佳方式是什么。在我的理想世界中，候选人不应该为面试做“准备”,面试只是对工作中一天的模拟。在这种情况下，我尝试了不同的形式，带回家挑战，白板面试，算法和数据结构部分，现场编码会议，调试会议，等等。我对这个话题有很多看法(和其他经理一样)。但总而言之，在我看来，白板面试是评估候选人时使用的一个很好的“工具”。
...
[Blockstack](https://www.keyvalues.com/blockstack) 的工程合作伙伴，之前创立了 Pay4Bugs。

我不认为白板面试特别有用，因为它不能反映工作的实际情况。开放式编码挑战涉及到使用我们的软件来构建一些东西，这给了我们关于候选人的技能水平和他或她对项目的兴趣的更多信息。

作为一个开源项目，我们很幸运，因为对我们的项目真正感兴趣的候选人可以通过发送拉式请求或在我们的平台上构建应用来证明自己——在某些情况下，这意味着我们可以在不要求该人做额外的编码挑战的情况下提供服务。

# [德瑞克·哈里森](https://www.linkedin.com/in/derreksharrison/)
...
这篇文章中引用的每个人都是一家公司的招聘经理，在[的关键价值观](https://www.keyvalues.com/)上。你可以通过阅读他们团队的简介来了解他们的工程文化，如果你仍然感兴趣，我鼓励你直接联系他们。

*原载于*[*www.keyvalues.com*](https://www.keyvalues.com/blog/engineering-whiteboard-interviews-yay-or-nay)*。*