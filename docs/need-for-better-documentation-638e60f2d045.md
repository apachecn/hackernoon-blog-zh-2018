...
> **Web 服务器、框架、数据库、库、脚本、任何工具、web 应用程序、web 应用程序中的数据收集、贵公司的内部应用程序，或者供贵公司的其他开发人员和内部用户使用的任何代码都应被视为产品。而我们，作为开发者，做得还不够。**

**是真的。不考虑产品和用户会导致我们的工作出现缺口——缺乏自动化、没有打包、没有文档、没有指南、不完整的端到端用户体验会影响工作效率。**

**由于开发人员负责为客户构建产品，并构建影响组织中其他开发人员和人员的系统，他们也应该将自己的工作视为产品开发。他们不仅应该关注向客户交付价值，还应该关注负责向客户交付价值的组织。这就是为什么你在工程组织的哪一层并不重要，作为一名开发人员，你可以为移动应用程序构建功能，构建连续交付管道或为配置管理编写傀儡模块，开发人员所做的一切都为组织中的某人创造价值，因此他们应该将他们的工作视为产品开发。**

**我们要从用户和产品的角度去思考。我们编写的文档是我们产品的一部分，为努力工作的用户创造价值。**

# **我们为谁工作？**

**一个朋友最近在脸书上发帖说:**

> **那些认为项目文档化很容易的人，对项目文档化有非常模糊的概念。**

**我发现这句话有很多道理，主要是因为我发现很难使用很多项目，如果它们有好的文档，这些项目可能会非常有用。我也相信这种说法，因为没有为他们的项目做好文档的项目维护人员通常不会对他们的用户(即其他开发人员、操作工程师、QA 工程师、设计师、开源贡献者、任何可能对以某种方式使用他们的项目感兴趣的人)产生共鸣，可能是因为他们甚至不知道他们的所有用户是谁。而这很可能是因为他们没有从用户和产品的角度去思考。这让我担心。因为他们对用户没有同理心，他们没有足够努力地思考他们可能需要什么来轻松地使用他们的代码或项目。**

**让我们探索一下你可能为之工作的一些用户。**

## **客户(为您的代码付费的人)**

**除非你写代码是为了娱乐或学术目的，否则你是在一个团队中工作，你所做的工作为一些客户创造了价值，这些客户为你的价值付钱。您的代码可能是更大的代码库的一部分，该代码库作为具有用户界面的产品向您的消费者公开。**

**你们中的一些人可能正在开发面向其他开发者的产品，这可能涉及到使用代码作为用户使用产品的接口(例如，Sentry、New Relic 等)。).这就是为什么您可能需要文档的一个原因——让您的客户(在其他公司工作的开发人员)能够在他们的代码或基础设施中使用您构建的产品(您的库)。我认为这是直截了当的，不需要太多的解释。**

**但是直截了当地说，在印度有一些 SAAS 服务(我不会指名道姓)，我不得不在不幸的情况下使用，这些服务不太关心良好的开发人员体验(不一致或设计糟糕的 API，没有文档或文档不正确)，导致非常糟糕的开发人员体验(这段代码的集成和未来维护)，导致与支持人员和客户经理的接触点增加， 导致缺乏完整上下文的电子邮件通信链，导致更多浪费的人工参与，导致支持人员和开发人员之间浪费的通信，因为即使支持也不能解决所有问题，并且必须在内部麻烦开发人员，导致更高的成本。 明白这一点——这对任何人都没有好处，甚至对你的生意也没有好处。如果有好的文档就好了，这种周而复始的工作就没有必要了，这样可以节省很多生产时间和精神压力。**

**投资良好的文档对于交付良好的客户体验和降低支持成本具有商业意义。**

## **内部用户**

**您可能需要文档的另一个原因是为了内部用户。你很少独自开发任何软件。几乎所有的软件都是由开发人员、sre、QA 工程师、产品经理、分析师和设计师组成的团队开发的。根据你的团队的结构和工作方式，你可能有多个内部用户，这是我们忽略的一个非常重要的方面，使得内部用户很难使用我们编写的代码和构建的软件。**

**让我把开发人员过分关注代码质量的观点带回来。就像我说的，这是一件非常好的事情。但是我们经常把自己局限于代码质量，而不是端到端的体验。作为开发人员，我们应该问的一些问题是:**

*   **我的 QA 工程师如何在本地设置测试服务？**
*   **我们的 sre 应该关注生产中的哪些指标？**
*   **新的实习生或团队成员如何快速建立这个项目以供开发？**

**对于我们来说，重要的是要专注于如何给不熟悉我们代码库的开发人员(实习生或新团队成员)或受我们代码库影响但不积极开发的开发人员(SREs、QA 工程师)提供良好的体验。**

**而且不仅仅是开发者。对我们来说，考虑其他受我们的代码影响的人是很重要的。让我们看看还有哪些人可能会受到我们代码的影响，以及如何受到影响:**

1.  ****最重要的** —你的工作对**你的客户**最重要。大多数开发人员从不直接为他们的客户工作，在他们之间有一层业务人员或产品经理，他们会为客户处理相关的文档。但是如果你正在构建一个被其他开发者使用的产品(例如，Loggly，Sentry，New Relic 等。)，你可以很容易地站在他们的立场上，试图找出他们可能需要什么来轻松地使用你的产品或代码。我们中的大多数人不会为构建这种开发工具的公司工作，但我们中的许多人可能已经开源了我们的工作，我们应该从相同的角度来看待这一点。大部分文档是解释如何使用 API 或您公开的接口的网页文本，但也可以包括工作演示、演示、视频、亲自尝试演示等。是的，视频也可以被视为文档。这真的取决于什么对你的用户有效。**
2.  ****你团队中的其他开发者(甚至是你自己)**——也是你的用户。如果你在一个团队中工作，试图解决一个问题，并且作为其中的一部分，你写了一个团队中的其他人必须使用的库，在没有任何文档的情况下，他们将如何使用它并完成他们的工作呢？在没有文档的情况下，他们会问你或者试图阅读你的代码。这既浪费了团队的宝贵时间，又增加了上下文切换。当你几个月不在那个库上工作，而现在不得不修复那个讨厌的 bug 时，你会做什么呢？我打赌你自己会忘记这个库是做什么的，如何设置它的开发环境，如何运行测试等等。如果你没有这些东西的文档。**
3.  **新开发人员加入您的团队 —缺乏文档通常会给工程师带来非常糟糕的入职体验。一个新的工程师能够开始工作的唯一方法是通过现有成员的大量帮助和反复试验——这又一次浪费了团队的时间和新成员生产的时间。别忘了你的新成员会很沮丧。我并不是说文档会消除手把手的需要，但它肯定能在很大程度上减少这种需要。问问你自己——你的项目是否有足够的文档记录，以至于一个新的团队成员可以在同一天提交并部署一个小的补丁到产品中？**
4.  ****您公司中的其他开发人员，但不是您团队中的开发人员** —拥有良好工程文化的大公司通过重用他们现有的解决方案来节省时间和金钱。为什么要建造以前已经建造过的东西？为什么要解决一个已经解决的问题？为什么要重新发明轮子？有道理，对吧。但你做了足够的努力来避免这种情况发生吗？您的项目是否有足够的文档，以便公司中的其他人可以发现它们，知道它们做什么，可以轻松地设置它们并开始使用它们？如果他们在使用这些项目时遇到困难，他们能向你寻求帮助，而不是从头再来吗？如果他们发现你的工作非常有用，他们可以提交一个补丁来增加一个新功能或修复一个错误，以帮助公司的每个人吗？优秀的工程团队通过加强协作来充分利用规模经济。协作必须有良好的文档支持，因为面对面的交互可能不太可能或者太困难。重要的是，你不仅要为你自己和你的团队做记录，还要为其他可能从你的工作中受益的人做记录，以避免浪费，避免自己重建已经存在的东西，并利用这些时间和金钱创造新的更有影响力的东西。这在商业上是明智的，在个人层面上也是更好地利用你的时间。**
5.  ****你公司之外的开发者(开源)** —如果你正在从事开源项目或者你的公司决定开源，第 2、3 和 4 点也适用。如果你正确地遵循第 2、3 和 4 点，这可能很容易实现，因为你已经完成了大部分工作。开源与否也是你公司的决定，但是伟大的公司从开源中受益匪浅。因此，用最少的努力开发你的开源软件可能是有意义的，这意味着从一开始就应该关注文档。**
