# 在哪里以及如何购买 DGD (DigixDAO)

> 原文：<https://medium.com/hackernoon/where-how-to-buy-dgd-digixdao-698274833629>

综合指南了解什么是 DigixDAO，它的令牌，目的以及如何从币安购买 DGD 令牌。

![](img/b982f1905d59a5ee09fbf39a6e56cf1e.png)

## DigixDAO 简介

我认为至少了解你要购买的东西的最基本的东西是很重要的，所以这篇文章和以后所有的文章都将包括一个简短的介绍来帮助你开始。

**Digix** 在以太坊上令牌化黄金。我们利用分布式分类账的不变性、透明性和可审计性，将其应用于珍贵的实物资产。Digix 创造了一系列技术，包括以太坊上的资产证明协议(POA)和 Digix 黄金令牌(DGX)。

## 我们开始吧

首先，我们需要购买比特币或[以太坊](https://hackernoon.com/a-beginners-guide-to-buying-ethereum-e11c73b5e5ed)才能在交易所购买任何加密货币。因此，按照下面的链接在[比特币基地](https://www.coinbase.com/join/5940a7b706041a01971db0ec)购买以太坊，然后按照下面的步骤在[币安](https://www.binance.com/?ref=27693113)购买 DGD。如果你已经有以太坊，你可以跳过这一步，直接去[币安](https://www.binance.com/?ref=27693113)注册。
...
> DGD 也可以用比特币购买——只是转移到另一个交易所需要更多时间，我建议用以太坊，因为只需要几分钟。
...
现在我们需要在货币列表中找到带有以太坊交易对的 DGD 硬币。看看下面的截图和说明。

![](img/826b8bb1545f41a48b47edc25bbf26ce.png)

*   选择右上角的 ETH 框。这意味着你在寻找可以用以太坊交易的硬币。
*   在硬币列表上方的搜索框中输入 DGD，它会如下所示过滤你。现在你可以看到 DGD/ETH 的当前价格。你现在几乎可以在 DGD 投资了。现在只需点击 DGD/ETH。
*   点击 DGD，弹出每日图表，左边是烛台和订单，如下所示。

![](img/a5b98eedc63fef2ee4fa69b59058f94a.png)

点击左侧所需的绿色价格，填写您在瑞士联邦理工学院的 DGD 价格(在上面的屏幕截图中当前显示为 0.63875)。单击后，它会变为 0.63390。现在你需要选择你愿意在 DGD 投资多少。按一下 25|50|75|100%,填入以该价格可以购买的 DGD 数量。

> 你可以从那些绿色数字中自由选择价格——它们基本上是其他人的不同报价——这也叫限购。

既然你是新手，你也可以点击*旁边的 ***行情*** 标签，选择 ETH 金额，点击 ***买入 DGD***——这基本上是以市场价买入。*

*一旦显示成功，你可以从右上角菜单进入 ***资金- >存款&取款*** ，搜索 DGD。*
