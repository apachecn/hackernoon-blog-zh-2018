...
> 原文：<https://medium.com/hackernoon/where-how-to-buy-elf-843cec63077f>

## 了解什么是 ELF，它的令牌，目的以及如何从币安购买 ELF (aelf)令牌的综合指南。

![](img/ef003c7a3f20142e2d257f765a00ed6e.png)

## ELF 简介

我认为至少了解你要购买的东西的最基本的东西是很重要的，所以这篇文章和以后所有的文章都将包括一个简短的介绍来帮助你开始。

**ELF** 令牌用于支付系统中的资源费用，如智能合约的部署、系统的运行和升级(交易费用、跨链数据传输费用)。它还使社区能够对重大决策进行投票，例如选举挖掘节点、向系统引入新功能以及其他重大决策。

## 我们开始吧

首先，我们需要购买比特币或[以太坊](https://hackernoon.com/a-beginners-guide-to-buying-ethereum-e11c73b5e5ed)才能在交易所购买任何加密货币。所以按照下面的链接在[比特币基地](https://www.coinbase.com/join/5940a7b706041a01971db0ec)购买以太坊，然后按照下面的步骤在[币安](https://www.binance.com/?ref=27693113)购买精灵。如果你已经有以太坊，你可以跳过这一步，直接去[币安](https://www.binance.com/?ref=27693113)注册。
...
> ELF 也可以用比特币购买——只是转移到另一个交易所需要更多时间，我建议用以太坊，因为只需要几分钟。
...
现在我们需要在货币列表中找到带有以太坊交易对的精灵币。看看下面的截图和说明。

![](img/cdffb186f052dd9789422515879d1f91.png)

*   选择右上角的 ETH 框。这意味着你在寻找可以用以太坊交易的硬币。
*   在硬币列表上方的搜索框中输入 ELF，它会如下所示过滤你。现在可以看到 ELF/ETH 的现价了。你现在差不多要投资 ELF 了。现在点一下 ELF/ETH 就行了。
*   点击 ELF，弹出每日图表，左侧是烛台和订单，如下所示。

![](img/b3c86f2d73ab7bfde49a000ff194f32f.png)

点击左侧所需的绿色价格，填写您在 ETH 中的 ELF 价格(当前在上面的屏幕截图中显示为 0.00292000)。单击后，它会变为 0.00289518。现在你需要选择你愿意在 ELF 上投资多少。按一下 25|50|75|100%,填入你能以这个价格买到的精灵数量。

> 你可以从那些绿色数字中自由选择价格——它们基本上是其他人的不同报价——这也叫限购。

既然你是新手，也可以点击*旁边的 ***行情*** 标签，选择 ETH 金额，点击 ***买入精灵***——这基本上就是以市场价买入。*

*一旦显示成功，可以从右上方菜单进入 ***资金- >存款&取款*** 搜索精灵。*
