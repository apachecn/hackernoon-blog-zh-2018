...
> 原文：<https://medium.com/hackernoon/where-how-to-buy-icx-icon-6096908d5eaf>

## 综合指南了解什么是图标，它的令牌，目的以及如何从币安购买 ICX 令牌。

![](img/d9fc6ba9b35895ecdb1d2d73deb5d2ed.png)

## 图标介绍

我认为至少了解你要购买的东西的最基本的东西是很重要的，所以这篇文章和以后所有的文章都将包括一个简短的介绍来帮助你开始。

图标项目正在建设世界上最大的分散式网络之一。ICON 得到了有影响力的区块链合作伙伴的支持，包括全球加速器、专注于加密货币的风险资本家、律师事务所和区块链媒体平台。

**让我们开始吧**

首先，我们需要购买比特币或[以太坊](https://hackernoon.com/a-beginners-guide-to-buying-ethereum-e11c73b5e5ed)才能在交易所购买任何加密货币。因此，请按照下面的链接在[比特币基地](https://www.coinbase.com/join/5940a7b706041a01971db0ec)上购买[以太坊](https://hackernoon.com/a-beginners-guide-to-buying-ethereum-e11c73b5e5ed)，然后按照下面的步骤在[币安](https://www.binance.com/?ref=27693113)上购买 ICX。如果你已经有[以太坊](https://hackernoon.com/a-beginners-guide-to-buying-ethereum-e11c73b5e5ed)了——你可以跳过这一步，直接去[币安](https://www.binance.com/?ref=27693113)注册。
...
> ICX 也可以用比特币购买——只是转移到另一个交易所需要更多时间，我建议用以太坊，因为只需要几分钟。
...
现在我们需要在货币列表中找到带有以太坊交易对的 ICX 硬币。看看下面的截图和说明。

![](img/e51b2485a36b863fe804036da2b30acd.png)

*   选择右上角的 ETH 框。这意味着你在寻找可以用以太坊交易的硬币。
*   在硬币列表上方的搜索框中输入 ICX，它会如下所示过滤你。现在你可以看到 ICX/ETH 的当前价格。你现在几乎可以在 ICX 投资了。现在只需点击 ICX/ETH。
*   点击 ICX，弹出每日图表，左边是烛台和订单，如下所示。

![](img/0a155f8eb47f95de87d1e299a8f31d82.png)

点击左侧所需的绿色价格，填写您在瑞士联邦理工学院的 ICX 价格(在上面的屏幕截图中当前显示为 0.004251)。单击后，它会变为 0.004251。现在你需要选择你愿意在 ICX 投资多少。按一下 25|50|75|100%,填入以该价格可以购买的 ICX 数量。

> 你可以从那些绿色数字中自由选择价格——它们基本上是其他人的不同报价——这也叫限购。

既然你是新手，你也可以点击 ***市场*** 标签，在*旁边，选择 ETH 金额，点击 ***买入 ICX***——这基本上是以市场价格买入。*

*一旦显示成功，你可以从右上角菜单进入 ***资金- >存款&取款*** ，搜索 ICX。*
