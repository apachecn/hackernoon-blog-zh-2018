# 在哪里以及如何购买 NCASH (Nucleus Vision)

> 原文：<https://medium.com/hackernoon/where-how-to-buy-ncash-nucleus-vision-ecef012e3013>

了解什么是 Nucleus Vision、它的令牌、用途以及如何从币安购买 NCASH 令牌的综合指南。

![](img/d7f2a3655f5f8dbde879206a37e2309d.png)

## Nucleus Vision 简介

我认为至少了解你要购买的东西的最基本的东西是很重要的，所以这篇文章和以后所有的文章都将包括一个简短的介绍来帮助你开始。

**Nucleus** 是一种端到端技术解决方案，通过其专有的区块链和实时传感器技术，捕捉并向零售商和其他实体企业提供以前无法访问的数据。

## 我们开始吧

首先，我们需要购买比特币或[以太坊](https://hackernoon.com/a-beginners-guide-to-buying-ethereum-e11c73b5e5ed)才能在交易所购买任何加密货币。因此，请点击下面的链接在[比特币基地](https://www.coinbase.com/join/5940a7b706041a01971db0ec)购买以太坊，然后按照下面的步骤在[币安](https://www.binance.com/?ref=27693113)购买 NCASH。如果你已经有以太坊，你可以跳过这一步，直接去[币安](https://www.binance.com/?ref=27693113)注册。
...
> NCASH 也可以用比特币购买——只是转移到另一个交易所需要更多时间，我建议用以太坊，因为只需要几分钟。
...
现在我们需要在货币列表中找到带有以太坊交易对的 NCASH 硬币。看看下面的截图和旁边的说明。

![](img/bb5739577ef37f99c6e9a18d557e420b.png)

*   选择右上角的 ETH 框。这意味着你在寻找可以用以太坊交易的硬币。
*   在硬币列表上方的搜索框中输入 NCASH，它会如下所示过滤你。现在可以看到当前价格的 NCASH/ETH。你现在差不多要投资 NCASH 了。现在只需点击 NCASH/ETH。
*   点击 NCASH，弹出每日图表，左侧是烛台和订单，如下所示。

![](img/6a5ff326c4657b7949c21a7494775b67.png)

点击左侧所需的绿色价格，填写您在 ETH 中的 NCASH 价格(在上面的屏幕截图中当前显示为 0.00004648)。单击后，它会变为 0.00004611。现在，你需要选择你想在 NCASH 上投资多少 ETH。点击 25|50|75|100%,填写以该价格可以购买的 NCASH 金额。

> 你可以从那些绿色数字中自由选择价格——它们基本上是其他人的不同报价——这也叫限购。

既然你是新手，你也可以点击*旁边的 ***行情*** 标签，选择 ETH 金额，点击 ***买入 NCASH***——这基本上就是以市场价买入。*

*一旦显示成功，可以从右上方菜单进入 ***资金- >存款&取款*** 搜索 NCASH。*
