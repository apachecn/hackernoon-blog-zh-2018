# 在哪里以及如何购买 VEN (Vechain)

> 原文：<https://medium.com/hackernoon/where-how-to-buy-vechain-ven-fe38cc4cfe32>

## 综合指南了解什么是 Vechain(即将成为 VeChain Thor)，它的令牌，目的以及如何从币安购买 VEN 令牌。

![](img/0db9094c917776f07aac256ea8462cf9.png)

## Vechain 简介

我认为至少了解你要购买的东西的最基本的东西是很重要的，所以这篇文章和以后所有的文章都将包括一个简短的介绍来帮助你开始。

**Vechain** (即将成为 VeChain Thor)是一家区块链即服务公司，其使命是构建“一个无信任的分布式商业生态系统，以实现透明的信息流、高效的协作和高速的价值转移。”包括奢侈品、农业、物流、食品/药品和政府在内的几个行业已经在使用维信区块链技术。

## 我们开始吧

首先，我们需要购买比特币或[以太坊](https://hackernoon.com/a-beginners-guide-to-buying-ethereum-e11c73b5e5ed)才能在交易所购买任何加密货币。所以按照下面的链接在[比特币基地](https://www.coinbase.com/join/5940a7b706041a01971db0ec)购买以太坊，然后按照下面的步骤在[币安](https://www.binance.com/?ref=27693113)购买 VEN。如果你已经有以太坊，你可以跳过这一步，直接去[币安](https://www.binance.com/?ref=27693113)注册。
...
> 也可以用比特币购买虚拟货币——只是转移到另一个交易所需要更多时间，我建议用以太坊，因为只需要几分钟。
...
现在我们需要在货币列表中找到带有以太坊交易对的硬币。看看下面的截图和说明。

![](img/705a460a8295dab36e789db1c86daf09.png)

*   选择右上角的 ETH 框。这意味着你在寻找可以用以太坊交易的硬币。
*   在硬币列表上方的搜索框中输入 VEN，它会如下所示过滤你。现在你可以看到当前价格。你现在差不多要投资 VEN 了。现在只需点击 VEN/ETH。
*   点击 VEN，弹出每日图表，左侧是烛台和订单，如下所示。

![](img/a4552d18202a3781ab66f443ed4b8b9d.png)

点击左侧所需的绿色价格，填写您在 ETH 中的 VEN 价格(当前在上面的屏幕截图中显示为 0.00596003)。单击后，它会变为 0.00596003。现在，你需要选择你愿意在 VEN 上投资多少。按一下 25|50|75|100%,填入您能以该价格购买的点数。

> 你可以从那些绿色数字中自由选择价格——它们基本上是其他人的不同报价——这也叫限购。

既然你是新手，你也可以点击*旁边的 ***行情*** 标签，选择 ETH 金额，点击 ***买入 VEN***——这基本上是以市场价买入。*

*一旦显示成功，可以从右上角菜单进入 ***资金- >存款&取款*** 搜索 VEN。*
